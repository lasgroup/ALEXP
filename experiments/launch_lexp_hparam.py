...
import run_lexp_hparam as script_to_run
import argparse
import numpy as np
import copy
import os
...
def main(args):
    ...
    # submit jobs
    generate_run_commands(command_list, num_cpus=args.num_cpus, mode='local_async', promt=True, duration='3:59:00') #euler or local_async

if __name__ == '__main__':
    # experiments
    parser = argparse.ArgumentParser(description='Tuning Exp')
    parser.add_argument('--exp_name', type=str,  default='corral_hparam_discrete') #required=True,
